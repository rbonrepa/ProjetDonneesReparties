...
public class CentralizedLindaParallel implements Linda {
    ...
    public CentralizedLindaParallel() {
    ...
    public Tuple take(Tuple template) {
        ...
        if (this.tuplespace.containsKey(size)) {
            ...
            IndexedTuple res = pool.invoke(finder);
            if (res.getTuple() != null) {
                this.tuplespace.get(size).remove(res.getIndex());
                endEdit();
                return res.getTuple();
            }
        }
